    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Введите кратное описание книги', max_length=1000, verbose_name='Аннотация книги')),
                ...
                ('autor', models.ManyToManyField(help_text='Выберите автора (авторов) книги', to='catalog.author', verbose_name='Автор (авторы) книги')),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите наименование издательтсва', max_length=20, verbose_name='Издательство')),
            ],
        ),
        migrations.CreateModel(
            name='Status',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(help_text='Изменить состояние эксемпляра', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.status', verbose_name='Статус экземпляра книги')),
            ],
            options={
                'ordering': ['due_back'],
            },
